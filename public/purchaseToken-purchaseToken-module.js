...
var PurchaseTokenComponent = /** @class */ (function () {
    function PurchaseTokenComponent() {
        this.amount = true;
        this.cities = [
